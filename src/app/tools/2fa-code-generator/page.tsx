      ...
      <div className="max-w-4xl mx-auto space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-gray-400 max-w-2xl mx-auto text-lg leading-relaxed">
            Verify your aged account credentials instantly. No data leaves your browser and computation stays local.
          </p>
        </div>
        ...
        <div className="p-8 md:p-12 rounded-3xl bg-gradient-to-br from-[#4F46E5]/20 via-black to-black border border-[#4F46E5]/30 flex flex-col md:flex-row items-center justify-between gap-8 group">
          <div className="space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-400 max-w-md">
              Browse our premium 2010-2026 inventory with pre-configured 2FA and OGE access.
              High trust and zero friction.
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-12">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500 leading-relaxed">
              When you purchase a premium aged account from The Armory, you receive a 2FA secret key (usually 16-32 characters).
              Paste that key into the field above to generate the active 6-digit login code. This tool follows the RFC 6238
              standard for Time-Based One-Time Passwords (TOTP).
            </p>
          </div>
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-white uppercase tracking-tighter">Privacy and security notice</h3>
            <p className="text-sm text-gray-500 leading-relaxed">
              Unlike public verifiers, The Armory 2FA Generator runs inside your browser memory. Secret keys are never sent to
              our servers or persisted in a database. This is a client-side utility designed for high operational security.
            </p>
          </div>
        </div>
      </div>
